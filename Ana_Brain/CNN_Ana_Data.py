...
import numpy as np
from ReadBrainData import input_MI_data
...
trX, trY, teX, teY = input_MI_data('ZZW1_Segmentation.dat.mat', 'ZZW2_Segmentation.dat.mat', 'ZZW3_Segmentation.dat.mat', 'label_zzw.mat')
...
w_layer_4 = init_weights([6*4*128, 1000])
# 定义全连接权重矩阵
w_layer_5 = init_weights([1000, 2])
